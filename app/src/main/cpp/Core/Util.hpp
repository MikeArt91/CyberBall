#ifndef CYBERBALL_UTIL_HPP
#define CYBERBALL_UTIL_HPP
...
// counts number of digits in function
template<typename T> T numOfDigits(T number)
{
    int digits = 0;
...
template <typename t, size_t n> size_t getArrayLen(t (&a)[n])
{
    return n;
}
*/
