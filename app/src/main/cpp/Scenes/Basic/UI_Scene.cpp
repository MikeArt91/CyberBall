...
const static float BUTTON_FOCUS_COLOR[] = { 1.0f, 0.5f, 0.0f };
//const static float BUTTON_DISABLED_COLOR[] = { 1.0f, 1.0f, 1.0f }; // previous all 0.3f
...
void UiScene::DoFrame() {
    ...
    if(!mTimeSet) {mTransitionStart=Clock(); mTimeSet=true;}
...
void UiWidget::Render(TrivialShader *trivialShader, TextRenderer *textRenderer,
    ...
    const float *color = (mIsButton && focus == FOCUS_YES) ? BUTTON_FOCUS_COLOR : mTextColor;
...
void UiScene::ResetTransitionTimer() {mTimeSet=false;}
